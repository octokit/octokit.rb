...
describe Octokit::Client::Users do
  ...
  describe '.migrations', :vcr do
    it 'starts a migration for a user' do
      result = @client.start_user_migration(['snakeoil-ceo/the-insecure'], accept: preview_header,
