  ...
  context "with repository" do
    ...
    describe ".create_tree", :vcr do
      it "creates a tree" do
        tree = @client.create_tree(@test_repo, [ { "path" => "wynning.rb", "mode" => "100644", "type" => "blob", :content => "require 'fun'"} ])
    ...
    describe ".create_blob", :vcr do
      it "creates a blob" do
        blob = @client.create_blob(@test_repo, "content")
    ...
    describe ".create_tag", :vcr do
      it "creates a tag" do
        sha = @client.commits(@test_repo).first.sha
