...
describe Octokit::Client::Commits do
  ...
  describe ".commits" do
    ...
    it "should return all commits" do
      stub_get("https://api.github.com/repos/sferik/rails_admin/commits?per_page=35&sha=master").
  ...
  describe ".commit" do
    ...
    it "should return a commit" do
      stub_get("https://api.github.com/repos/sferik/rails_admin/commits/3cdfabd973bc3caac209cba903cfdb3bf6636bcd").
