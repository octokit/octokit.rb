...
describe Octokit::Client::Commits do
  ...
  describe '.commits_on', :vcr do
    it 'returns all commits on the specified date' do
      ...
      assert_requested :get,
                       github_url('/repos/sferik/rails_admin/commits?since=2011-01-20T00:00:00%2B00:00&until=2011-01-21T00:00:00%2B00:00')
    end
    ...
    it 'handles branch or sha argument' do
      ...
      assert_requested :get,
                       github_url('/repos/sferik/rails_admin/commits?sha=master&since=2011-01-15T00:00:00%2B00:00&until=2011-01-16T00:00:00%2B00:00')
    end
    it 'handles the sha option' do
  ...
  describe '.commits_since', :vcr do
    ...
    it 'handles branch or sha argument' do
      ...
      assert_requested :get,
                       github_url('/repos/sferik/rails_admin/commits?sha=master&since=2011-01-15T00:00:00%2B00:00')
    end
    it 'handles the sha option' do
  ...
  describe '.commits_before', :vcr do
    ...
    it 'handles branch or sha argument' do
      ...
      assert_requested :get,
                       github_url('/repos/sferik/rails_admin/commits?sha=master&until=2011-01-15T00:00:00%2B00:00')
    end
    it 'handles the sha option' do
  ...
  describe '.commits_between', :vcr do
    it 'returns all commits until the specified date' do
      ...
      expect(commits).to be_kind_of Array
      assert_requested :get,
                       github_url('/repos/sferik/rails_admin/commits?since=2011-01-20T00:00:00%2B00:00&until=2013-01-20T00:00:00%2B00:00')
    end
    it 'errors if the date is invalid' do
    ...
    it 'handles branch or sha argument' do
      ...
      assert_requested :get,
                       github_url('/repos/sferik/rails_admin/commits?sha=master&since=2011-01-20T00:00:00%2B00:00&until=2013-01-20T00:00:00%2B00:00')
    end
    it 'handles the sha option' do
  ...
  describe '.git_commit', :vcr do
    it 'returns a detailed git commit' do
      ...
      assert_requested :get,
                       github_url('/repos/octokit/octokit.rb/git/commits/2bfca14ed8ebc3dad75082ff175e6703aed7ccc0')
    end
  end
  ...
  describe '.compare', :vcr do
    it 'returns a comparison' do
      comparison = @client.compare('gvaughn/octokit', '0e0d7ae299514da692eb1cab741562c253d44188',
      ...
      assert_requested :get,
                       github_url('/repos/gvaughn/octokit/compare/0e0d7ae299514da692eb1cab741562c253d44188...b7b37f75a80b8e84061cd45b246232ad958158f5')
    end

    it 'utilizes auto_pagination', :vcr do
      @client.auto_paginate = true
      comparison = @client.compare('mrpinsky/octokit.rb', 'b7b37f75a80b8e84061cd45b246232ad958158f5',
                                   '0e0d7ae299514da692eb1cab741562c253d44188', per_page: 1)

      expect(comparison.commits.length).to eq(2)
      assert_requested :get,
                       github_url('/repos/mrpinsky/octokit.rb/compare/b7b37f75a80b8e84061cd45b246232ad958158f5...0e0d7ae299514da692eb1cab741562c253d44188?per_page=1')
      assert_requested :get,
                       github_url('/repositories/387936585/compare/b7b37f75a80b8e84061cd45b246232ad958158f5...0e0d7ae299514da692eb1cab741562c253d44188?page=2&per_page=1')
    end
  end
end
