...
describe Octokit::Client::Contents do   
	...
	describe ".readme" do
		...
		it "should return the default readme" do 
			stub_get("/repos/pengwynn/octokit/readme?ref=master").
	...
	describe ".contents" do
		...
		it "should return the contents of a file" do
			stub_get("/repos/pengwynn/octokit/contents/lib/octokit.rb?ref=master").
		...
		it "should return the location of the archive from get header" do
			stub_get("/repos/pengwynn/octokit/tarball/master").
				to_return(:status => 302, :body => '', :headers => 
					{ 'location' => "https://nodeload.github.com/pengwynn/octokit/tarball/master"})
			archive_link = @client.archive_link('pengwynn/octokit')
			archive_link['location'] == "https://nodeload.github.com/pengwynn/octokit/tarball/master"
		end
