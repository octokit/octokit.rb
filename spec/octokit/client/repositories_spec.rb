...
describe Octokit::Client::Repositories do
  ...
  describe ".update_repository" do
    ...
    it "should update the matching repository" do
      ...
      stub_patch("https://api.github.com/repos/sferik/rails_admin").
  ...
  describe ".repositories" do
    ...
    context "with a username passed" do
      ...
      it "should return user's repositories" do
        stub_get("https://api.github.com/users/sferik/repos").
    ...
    context "without a username passed" do
      ...
      it "should return authenticated user's repositories" do
        stub_get("https://api.github.com/user/repos").
          to_return(:body => fixture("v3/repositories.json"))
  ...
  describe ".watch" do
    ...
    it "should watch a repository" do
      stub_put("https://api.github.com/user/watched/sferik/rails_admin").
  ...
  describe ".unwatch" do
    ...
    it "should unwatch a repository" do
      stub_delete("https://api.github.com/user/watched/sferik/rails_admin").
        to_return(:status => 204)
  ...
  describe ".fork" do
    ...
    it "should fork a repository" do
      stub_post("https://api.github.com/repos/sferik/rails_admin/forks").
        to_return(:body => fixture("v3/repository.json"))
  ...
  describe ".create_repository" do
    ...
    it "should create a repository" do
      stub_post("https://api.github.com/user/repos").
  ...
  describe ".deploy_keys" do
    ...
    it "should return a repository's deploy keys" do
      stub_get("https://api.github.com/repos/sferik/rails_admin/keys").
  ...
  describe ".add_deploy_key" do
    ...
    it "should add a repository deploy keys" do
      stub_post("https://api.github.com/repos/sferik/rails_admin/keys").
  ...
  describe ".remove_deploy_key" do
    ...
    it "should remove a repository deploy keys" do
      stub_delete("https://api.github.com/repos/sferik/rails_admin/keys/#{103205}").
        to_return(:status => 204)
  ...
  describe ".collaborators" do
    ...
    it "should return a repository's collaborators" do
      stub_get("https://api.github.com/repos/sferik/rails_admin/collaborators").
  ...
  describe ".add_collaborator" do
    ...
    it "should add a repository collaborators" do
      stub_put("https://api.github.com/repos/sferik/rails_admin/collaborators/sferik").
        to_return(:status => 204)
  ...
  describe ".remove_collaborator" do
    ...
    it "should remove a repository collaborators" do
      stub_delete("https://api.github.com/repos/sferik/rails_admin/collaborators/sferik").
        to_return(:status => 204)
  ...
  describe ".repository_teams" do
    ...
    it "should return all repository teams" do
      stub_get("https://api.github.com/repos/codeforamerica/open311/teams").
  ...
  describe ".contributors" do
    ...
    context "with anonymous users" do
      ...
      it "should return all repository contributors" do
        stub_get("https://api.github.com/repos/sferik/rails_admin/contributors?anon=true").
    ...
    context "without anonymous users" do
      ...
      it "should return all repository contributors" do
        stub_get("https://api.github.com/repos/sferik/rails_admin/contributors?anon=false").
          to_return(:body => fixture("v3/contributors.json"))
  ...
  describe ".watchers" do
    ...
    it "should return all repository watchers" do
      stub_get("https://api.github.com/repos/sferik/rails_admin/watchers").
  ...
  describe ".network" do
    ...
    it "should return a repository's network" do
      stub_get("https://api.github.com/repos/sferik/rails_admin/forks").
  ...
  describe ".languages" do
    ...
    it "should return a repository's languages" do
      stub_get("https://api.github.com/repos/sferik/rails_admin/languages").
  ...
  describe ".tags" do
    ...
    it "should return a repository's tags" do
      stub_get("https://api.github.com/repos/pengwynn/octokit/tags").
  ...
  describe ".branches" do
    ...
    it "should return a repository's branches" do
      stub_get("https://api.github.com/repos/pengwynn/octokit/branches").
