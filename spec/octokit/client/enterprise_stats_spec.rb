...
describe Octokit::Client::EnterpriseStats do
  ...
  end # .enterprise_organization_stats
  ...
  end # .enterprise_pull_requests_stats
  ...
  end # .enterprise_milestones_stats
