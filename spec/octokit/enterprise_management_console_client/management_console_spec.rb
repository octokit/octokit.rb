...
describe Octokit::EnterpriseManagementConsoleClient::ManagementConsole do
  ...
  describe '.edit_settings', :vcr do
    it 'edits the Enterprise settings' do
      ...
      assert_requested :put,
                       github_management_console_url("setup/api/settings?api_key=#{@api_key}&settings=%7B%22enterprise%22:%7B%22customer%22:%7B%22name%22:%22Jean-Luc%20Picard%22%7D%7D%7D")
    end
  end
  ...
  describe '.set_maintenance_status', :vcr do
    it 'enables the Enterprise maintenance mode' do
      ...
      assert_requested :post,
                       github_management_console_url("setup/api/maintenance?api_key=#{@api_key}&maintenance=%7B%22enabled%22:true,%22when%22:%22now%22%7D")
    end
  end
  ...
  describe '.add_authorized_key', :vcr do
    it 'adds a new authorized SSH keys (via a file path)' do
      ...
      assert_requested :post,
                       github_management_console_url("setup/api/settings/authorized-keys?authorized_key=ssh-rsa%&api_key=#{@api_key}")
    end
    ...
    it 'adds a new authorized SSH keys (via a File handler)' do
      ...
      assert_requested :post,
                       github_management_console_url("setup/api/settings/authorized-keys?api_key=#{@api_key}&authorized_key=ssh-rsa%")
    end
    ...
    it 'adds a new authorized SSH keys (via a string contents)' do
      ...
      assert_requested :post,
                       github_management_console_url("setup/api/settings/authorized-keys?api_key=#{@api_key}&authorized_key=ssh-rsa%")
    end
  end
  ...
  describe '.remove_authorized_key', :vcr do
    ...
    it 'removes a new authorized SSH keys (via a File handler)' do
      ...
      assert_requested :delete,
                       github_management_console_url("setup/api/settings/authorized-keys?authorized_key=ssh-rsa%&api_key=#{@api_key}")
    end
