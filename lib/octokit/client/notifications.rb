...
module Octokit
  class Client
    ...
    module Notifications
      ...
      # Mark as read
      #
      # @option options [String] :last_read_at Describes the last point that notifications were checked. Anything updated since this time will not be updated. This is a timestamp in ISO 8601 (https://en.wikipedia.org/wiki/ISO_8601) format: YYYY-MM-DDTHH:MM:SSZ. Default: The current timestamp.
