module Octokit
  class Client
    ...
    module Releases
      ...
      # @param options [String] :target_commitish Specifies the commitish value that determines where the Git tag is created from. Can be any branch or commit SHA. Unused if the Git tag already exists. Default: the repository's default branch (usually `master`).
      # @param options [String] :name The name of the release.
      # @param options [String] :body Text describing the contents of the tag.
      # @param options [Boolean] :draft `true` to create a draft (unpublished) release, `false` to create a published one.
      # @param options [Boolean] :prerelease `true` to identify the release as a prerelease. `false` to identify the release as a full release.
      ...
      # @param repo [Integer, String, Repository, Hash] A GitHub repository
      # @param release_id [Integer] The ID of the release
      # @param options [String] :tag_name The name of the tag.
      # @param options [String] :target_commitish Specifies the commitish value that determines where the Git tag is created from. Can be any branch or commit SHA. Unused if the Git tag already exists. Default: the repository's default branch (usually `master`).
      # @param options [String] :name The name of the release.
      # @param options [String] :body Text describing the contents of the tag.
      # @param options [Boolean] :draft `true` makes the release a draft, and `false` publishes the release.
      # @param options [Boolean] :prerelease `true` to identify the release as a prerelease, `false` to identify the release as a full release.
      ...
      # @param repo [Integer, String, Repository, Hash] A GitHub repository
      # @param asset_id [Integer] The ID of the asset
      # @param options [String] :name The file name of the asset.
      # @param options [String] :label An alternate short description of the asset. Used in place of the filename.
      # @return [Sawyer::Resource] 
