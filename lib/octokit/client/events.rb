module Octokit
  class Client
    ...
    module Events
      ...
      def public_events(options = {}, &block)
        paginate "events", options, &block
      end
      ...
      def user_events(user, options = {}, &block)
        paginate "#{User.path user}/events", options, &block
      end
      ...
      #   Octokit.user_events("sferik")
      def user_public_events(user, options = {}, &block)
        paginate "#{User.path user}/events/public", options, &block
      end
      ...
      def received_events(user, options = {}, &block)
        paginate "#{User.path user}/received_events", options, &block
      end
      ...
      def received_public_events(user, options = {}, &block)
        paginate "#{User.path user}/received_events/public", options, &block
      end
      ...
      def repository_events(repo, options = {}, &block)
        paginate "#{Repository.path repo}/events", options, &block
      end
      ...
      def repository_network_events(repo, options = {}, &block)
        paginate "networks/#{Repository.new(repo)}/events", options, &block
      end
      ...
      def organization_events(org, options = {}, &block)
        paginate "users/#{login}/events/orgs/#{org}", options, &block
      end
      ...
      def organization_public_events(org, options = {}, &block)
        paginate "#{Organization.path org}/events", options, &block
      end
      ...
      def repository_issue_events(repo, options = {}, &block)
        paginate "#{Repository.path repo}/issues/events", options, &block
      end
      ...
      def issue_events(repo, number, options = {}, &block)
        paginate "#{Repository.path repo}/issues/#{number}/events", options, &block
      end
      ...
      def issue_event(repo, number, options = {}, &block)
        paginate "#{Repository.path repo}/issues/events/#{number}", options, &block
      end
    end
  end
end
