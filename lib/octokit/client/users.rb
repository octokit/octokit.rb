module Octokit
  class Client
    module Users
      ...
      # @param client_id [String] Client Id we received when our application was registered with GitHub.
      # @param client_secret [String] Client Secret we received when our application was registered with GitHub.
